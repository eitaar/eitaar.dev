<template>
    <header><div class="absolute w-full z-10">
        ...
        <button class="transition-all duration-200 border-[0.35vmin] animate-showPage g-slate-950 bg-slate-200 border-slate-950  order-slate-200 ext-slate-200 px-[0.75vmin] py-[0.75vmin] absolute rounded z-10 top-[2vmin] right-[2vmin]">
        ...
        <!--Navigation links-->
        <div class=" top-[2vmin] right-[9vmin] border-[0.35vmin] animate-showPage px-[0.5vmin] py-[0.5vmin] absolute transition-all duration-200 rounded border-slate-950 order-slate-200 g-slate-950 bg-slate-200" @click="openUrl('https://github.com/eitaar')">
