<template>
    <header><div class="fixed w-full z-10">
        <NuxtLink to="/"><img src="~assets/logo.svg" alt="eitaar.dev Logo" class="w-[5.7vmin] absolute top-[2vmin] left-[2vmin] animate-loadLogo "></NuxtLink>
        <!--Dark/Light mode toggle btn-->
        <button class="transition-all duration-200 border-[0.35vmin] animate-showPage dark:bg-slate-950 border-slate-950  dark:border-slate-200 dark:text-slate-200 px-[0.75vmin] py-[0.75vmin] absolute rounded z-10 top-[2vmin] right-[2vmin]" @click="$colorMode.preference == 'light'?$colorMode.preference = 'dark':$colorMode.preference = 'light'">
        ...
        <!--Navigation links-->
        <div class=" top-[2vmin] right-[9vmin] border-[0.35vmin] animate-showPage px-[0.5vmin] py-[0.5vmin] absolute transition-all duration-200 rounded border-slate-950 dark:border-slate-200" @click="openUrl('https://github.com/eitaar')">
