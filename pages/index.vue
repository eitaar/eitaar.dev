<template>
    ...
    <!--Title Area-->
    <div class="animate-showPage"><div class="title-wrapper absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center font-bold text-5xl select-none">
    ...
    <div class="btn-container absolute top-[60%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 font-roboto">
    <button
