<template>
  ...
  <div class="font-Roboto">
    <div class="absolute w-[60vmin] h-[60vmin] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 order-slate-200 border-slate-950 transition-all duration-200 border-[0.5vmin] rounded-md ">
      <p class="ext-slate-200 text-slate-950 font-bold text-center transition-all duration-200 text-[3vmin] mt-[2vmin]">Login to eitaar.dev</p>
      <div class="absolute w-[80%] h-[40%] top-[37.5%] left-1/2 -translate-x-1/2 -translate-y-1/2 ">
        ...
        <input v-model="email" @focus="loginError = false" type="email" placeholder="email" class="w-full g-slate-900 bg-slate-300 h-[27.5%] outline-[0.25vmin] utline-slate-200 outline-slate-950 ext-slate-200 transform-all duration-200 text-[150%] pl-[2vmin] rounded"/>
        <input v-model="password" @focus="loginError = false" type="password" placeholder="password" class="w-full g-slate-900 bg-slate-300 h-[27.5%] outline-[0.25vmin] utline-slate-200 outline-slate-950 ext-slate-200 transform-all duration-200 text-[150%] pl-[2vmin] mt-[1vmin] rounded"/>
        <p></p>
        ...
        <p class="mt-[1.5vmin] text-[100%] text-center ext-slate-200 text-slate-950 transition-all duration-200">Not a user yet? <NuxtLink to="/signup" class="text-sky-700 ext-sky-400">Sign up</NuxtLink></p>
      </div>
    </div>
  </div>
</template>
