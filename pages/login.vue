<template>
  <div class="font-Roboto flex justify-center align-middle h-full">
    <fieldset class="fieldset w-1/4 bg-base-200 border border-base-300 p-4 rounded-box">
      ...
      <button class="btn btn-primary mt-4 btn-xs sm:btn-sm md:btn-md lg:btn-lg" @click="signInWithEmail">Login</button>
      ...
      <p class="text-center my-1.5 text-xs md:text-sm lg:text-md ">Not a user yet? <NuxtLink to="/signup" class="link link-info">Sign up</NuxtLink></p>
    </fieldset>
  </div>
</template>
<script setup>
