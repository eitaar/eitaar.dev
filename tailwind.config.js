export default {
  ...
  theme: {
    extend: {
      ...
      animation: {
        loadLogo: 'loadLogo 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards',
        showPage: 'showPage 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards',
      },
      keyframes: {
        loadLogo: {
          ...
          '47.5%': { transform: 'translate(-50%, -50%) scale(3)', left: '50vw', top: '50vh' },
